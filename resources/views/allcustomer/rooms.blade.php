    ...
    <nav id="navbar">
     ...
     <div class="rooms-container" id="rooms">
        <div class="card-roms1">
          <img src="{{ asset('images/rooms 1.jpg') }}" alt="Kamar Keluarga"></div>
        ...
        <div class="card-roms2">
          <img src="{{ asset('images/rooms 2.jpeg') }}" alt="Kamar Deluxe"></div>
        ...
        <div class="card-roms3">
          <img src="{{ asset('images/rooms 3.jpg') }}" alt="Kamar Premium"></div>
