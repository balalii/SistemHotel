<x-hotel-book>
    <x-slot:title >
        ...
        <div id="subnavbar" class="pb-2">

        
                <form class="max-w-md mx-auto py-4 md:py-4 flex-wrap">
                        <div class="flex">
    ...
    <div class="p-8 h-full bg-fixed bg-cover" style="background-color: #151419;">
            ...
            <div class="h-28 mb-8"></div>
            
            <div class="grid grid-cols-2 md:grid-cols-6 gap-4">
                @foreach ($kamar as $kamar)
                    <a href="{{ route('globalbook.view',$kamar->id) }}">
                        <div class="rounded-2xl p-4 space-y-4 text-white"style="background-color: #262626;">
                            ...
                            <h1>nomor kamar : {{$kamar->id}}</h1>
                            <p>{{$kamar->nama_kamar}}</p>
                            <p>type : {{$kamar->jenis_kamar}}</p>
                            <p>luas : {{$kamar->ukuran_kamar}}</p>
                            <div class="flex justify-start">
                                <p class="p-2 px-3 rounded-2xl" style="background-color: #f56e0f;">Rp.{{$kamar->harga_permalam}}</p>
                            </div>
